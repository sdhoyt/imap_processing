...
@pytest.fixture
def attr_mgr():
    attr_mgr_l1c = ImapCdfAttributes()
    attr_mgr_l1c.add_instrument_global_attrs(instrument="lo")
    attr_mgr_l1c.add_instrument_variable_attrs(instrument="lo", level="l1c")
    return attr_mgr_l1c
